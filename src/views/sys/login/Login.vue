        ...
        <div class="flex w-full h-full py-5 xl:h-auto xl:py-0 xl:my-0 xl:w-6/12">
          ...
          >
            <Tabs v-model:activeKey="activeKey">
                <TabPane key="1" tab="账号登录" force-render>
                  ...
                  <TabPane key="2" tab="扫码登录">
                    <div class="enter-x min-w-64 min-h-64">
                      <div class="qrcodebox">
                        ...
                        <div class="cash" v-show="qrCodeUrl=='12'" @click="goLogin">
                           <div class="ctext">
                              <div class="icon"><Icon icon="uiw:weixin" :size="32" /></div>
                             <div class="title">未绑定微信账号</div>
                             <a class="btn" >请使用账号密码登录</a>
                           </div>
                        </div>
                      </div>
...
<script lang="ts" setup>
 ...
 const { validForm } = useFormValid(formRef);
  ...
  const shortName = computed(() => globSetting?.shortName ?? '');
  const shortDes = computed(() => globSetting?.shortDes ?? '');
